			...
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
				<div className="lg:grid lg:grid-cols-3 lg:gap-10">
					<div>
						...
						<Logo className="mt-1 w-full max-w-sm lg:mt-4" />
					</div>
					<div className="mt-8 lg:mt-0">
						<h2 className="text-lg font-extrabold">Contact Info</h2>
						<dl className="mt-3 space-y-4 text-base leading-7 text-gray-400 lg:mt-5">
